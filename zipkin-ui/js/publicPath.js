...
const TRACERPATHPREFIX = TRACER_PATH_PREFIX; // eslint-disable-line camelcase, no-undef
// For npm run test comment above line and uncomment below line
// const TRACERPATHPREFIX = '/zipkin/'; // eslint-disable-line camelcase, no-undef
...
export {contextRoot, TRACERPATHPREFIX};
